    ...
    async with async_session_maker() as session:
        ...
        lessons = [
            ...
            Lesson(
                ...
                audio_file_path="audio/four_rules_lesson1.mp3",
                duration_minutes=30,
                lesson_number=1,
                book_id=books[0].id,
            ...
            Lesson(
                ...
                audio_file_path="audio/four_rules_lesson2.mp3",
                duration_minutes=25,
                lesson_number=2,
                book_id=books[0].id,
                teacher_id=teachers[0].id,
            ...
            Lesson(
                ...
                audio_file_path="audio/four_rules_lesson3.mp3",
                duration_minutes=35,
                lesson_number=3,
                book_id=books[0].id,
                teacher_id=teachers[0].id,
            ...
            Lesson(
                ...
                audio_file_path="audio/four_rules_lesson4.mp3",
                duration_minutes=40,
                lesson_number=4,
                book_id=books[0].id,
                teacher_id=teachers[0].id,
            ...
            Lesson(
                ...
                audio_file_path="audio/gardens_lesson1.mp3",
                duration_minutes=20,
                lesson_number=1,
                book_id=books[1].id,
            ...
            Lesson(
                ...
                audio_file_path="audio/gardens_lesson2.mp3",
                duration_minutes=25,
                lesson_number=2,
                book_id=books[1].id,
                teacher_id=teachers[1].id,
            ...
            Lesson(
                ...
                audio_file_path="audio/foundations_lesson1.mp3",
                duration_minutes=45,
                lesson_number=1,
                book_id=books[2].id,
                teacher_id=teachers[0].id,
